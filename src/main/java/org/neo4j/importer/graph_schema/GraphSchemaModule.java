...
import org.neo4j.importer.graph_schema.GraphSchema.NodeObjectType;
import org.neo4j.importer.graph_schema.GraphSchema.Property;
import org.neo4j.importer.graph_schema.GraphSchema.Ref;
import org.neo4j.importer.graph_schema.GraphSchema.RelationshipObjectType;
import org.neo4j.importer.graph_schema.GraphSchema.Token;
...
/**
 * A copy of https://github.com/neo4j/graph-schema-introspector/blob/main/src/main/java/org/neo4j/graph_schema/introspector/GraphSchemaModule.java
 * until any of this might get into a releasable shape.
 */
class GraphSchemaModule extends SimpleModule {
